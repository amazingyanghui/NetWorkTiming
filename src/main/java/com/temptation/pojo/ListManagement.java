...
public class ListManagement {
    ...
    private List<ListManagement> children;
	...
	public List<ListManagement> getChildren() {
		return children;
	}
	public void setChildren(List<ListManagement> children) {
	...
	public String toString() {
		return "ListManagement [id=" + id + ", name=" + name + ", parentId=" + parentId + ", sortnum=" + sortnum
