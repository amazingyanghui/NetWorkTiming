...
function judge() {
	if($("#area").val().trim()==null || $("#area").val().trim()==""){
        ...
        $.ajax({
            type:'post',
            url:'../grouplist/queryListManagementById',
            data: {'id':id},
...
function addMaintens(){
    ...
    $.ajax({
        type:'post',
        url:'../grouplist/addListManagement',
        data: listmanagement,
        success:function (result) {
            if(result==1){
                location.href="../html/listmanagement.html"
            }else{
                layer.msg("增加失败！")
            }
        },
...
function updateMaintens() {
    ...
    $.ajax({
        type:'post',
        url:'../grouplist/updateListManagement',
        data: listmanagement,
        success:function (result) {
            if(result==1){
                location.href="../html/listmanagement.html"
